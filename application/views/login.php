        ...
        <div class="animate form login_form">
          <section class="login_content">
            ...
            <form id="formulario">
              ...
              <h3>Programacion</h3>
              <div>
                <input type="text" class="form-control" placeholder="C.U." required="" id="cu" />
              </div>
              <div>
    ...
    <script src="<?php echo base_url()?>assets/vendors/jquery/dist/jquery.min.js"></script>
     <script>
      $(document).ready(function() {
        ...
        var urlPost ='http://localhost/laboratorio/index.php/Programacion/login';
            ...
            $.ajax({
                    ...
                    success: function(data)
                    {
                        if(data==0){
                            ...
                            var url = 'http://localhost/laboratorio/index.php/Programaciones/Programaciones/';
                            window.location = url;
                        }
                    },
